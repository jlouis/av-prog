...
\begin{frame}[fragile]
Can now make a applicative distributor for lists:\\
\begin{align*}
...
\quad & \mathrm{pure} \_ = \mathrm{Acc} \; \emptyset\\
\quad & \mathrm{Acc} \; o_1 \circledast \mathrm{Acc}\;  o_2 = \mathrm{Acc}(o_1 \oplus o_2)
\end{align*}
\end{frame}
