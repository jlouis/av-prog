\chapter*{Task 1 -- The Universal Machine}
\label{chap:task+1}
...
The machine store underwent several iterations before settling. We
...
list. \fixme{Johan: Check this} Of course, this was too slow for the
